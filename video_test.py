...
def init_det_and_emb_model(model_file = "ghostnetv1_w1.3_s1_basic_model_latest.h5"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model_file",default="ghostnetv1_w1.3_s1_basic_model_latest.h5", type=str, help="Saved basic_model file path, NOT model")
